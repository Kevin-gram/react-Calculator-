...
const Calculator = () => {
  ...
  return (
    <div className="w-2/5 m-auto">
      <h1 className="text-center  bg-white py-3">Calculator Application</h1>
      ...
      <div>
        <div className="grid grid-cols-4">
          <span
            className=" border flex justify-center py-9 border-black"
          ...
          <span className=" border flex justify-center py-9 border-black">
            .
          </span>
          <span
            className=" border flex justify-center py-9 border-black"
          ...
          <span
            className="bg-yellow-600 border flex justify-center py-9 border-black"
            onClick={() => handleOperatorClick("/")}
          >
            /
          </span>
          ...
          <span
            className="bg-yellow-600  grid-cols-2  border  border-black flex justify-center py-9"
            onClick={() => handleOperatorClick("+")}
          >
            +
          </span>
